    ...
    try {
        const settings = await prisma.systemSetting.findUnique({
            ...
            select: {
                ...
                schoolBasicPlanName: true,
                schoolBasicPlanPrice: true,
                schoolBasicPlanLessonLimit: true,
                schoolStandardPlanName: true,
                schoolStandardPlanPrice: true,
                schoolStandardPlanLessonLimit: true,
                schoolProPlanName: true,
                schoolProPlanPrice: true,
                schoolProPlanLessonLimit: true,
                paystackPublicKey: true,
                proPlanCode: true,
                schoolBasicPlanCode: true,
                schoolStandardPlanCode: true,
                schoolProPlanCode: true,
                individualTopUpPrice: true,
                individualTopUpAmount: true,
                schoolTopUpPrice: true,
                schoolTopUpAmount: true,
            }
        });
...
const updateSettings = asyncHandler(async (req, res) => {
    const {
        ...
        schoolBasicPlanName,
        schoolBasicPlanPrice,
        schoolBasicPlanLessonLimit,
        schoolStandardPlanName,
        schoolStandardPlanPrice,
        schoolStandardPlanLessonLimit,
        schoolProPlanLessonLimit,
        individualDailyLimit,
        schoolTeacherDailyLimit,
        proPlanCode,
        schoolBasicPlanCode,
        schoolStandardPlanCode,
        schoolProPlanCode,
        individualTopUpPrice,
        individualTopUpAmount,
        schoolTopUpPrice,
        schoolTopUpAmount
    } = req.body;
    ...
    try {
        ...
        const updateData = {
            ...
            schoolPlanDuration: (req.body.schoolPlanDuration || 'month').trim(),
            schoolBasicPlanName: (req.body.schoolBasicPlanName || 'Basic School').trim(),
            schoolBasicPlanPrice: Number(req.body.schoolBasicPlanPrice) || 20000,
            schoolBasicPlanLessonLimit: Number(req.body.schoolBasicPlanLessonLimit) || 500,
            schoolStandardPlanName: (req.body.schoolStandardPlanName || 'Standard School').trim(),
            schoolStandardPlanPrice: Number(req.body.schoolStandardPlanPrice) || 50000,
            schoolStandardPlanLessonLimit: Number(req.body.schoolStandardPlanLessonLimit) || 1500,
            schoolProPlanName: (req.body.schoolProPlanName || 'Pro School').trim(),
            schoolProPlanPrice: Number(req.body.schoolProPlanPrice) || 100000,
            schoolProPlanLessonLimit: Number(req.body.schoolProPlanLessonLimit) || 5000,
            individualDailyLimit: Number(req.body.individualDailyLimit) || 3,
            schoolTeacherDailyLimit: Number(req.body.schoolTeacherDailyLimit) || 5,
            proPlanCode: (req.body.proPlanCode || '').trim(),
            schoolBasicPlanCode: (req.body.schoolBasicPlanCode || '').trim(),
            schoolStandardPlanCode: (req.body.schoolStandardPlanCode || '').trim(),
            schoolProPlanCode: (req.body.schoolProPlanCode || '').trim(),
            individualTopUpPrice: Number(req.body.individualTopUpPrice) || 1000,
            individualTopUpAmount: Number(req.body.individualTopUpAmount) || 100,
            schoolTopUpPrice: Number(req.body.schoolTopUpPrice) || 5000,
            schoolTopUpAmount: Number(req.body.schoolTopUpAmount) || 500
        };
