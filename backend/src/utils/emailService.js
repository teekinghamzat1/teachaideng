                ...
                <body>
                    <div class="container">
                        ...
                        <div class="footer">
                            ...
                            <p>A product of Cognovia Technologies Ltd · RC: 9394151</p>
                        </div>
                    </div>
                </body>
                </html>
            ...
            html: `
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="footer">
                            <p>Generated by ${settings.siteName || 'TeachAide'} - Empowering Educators</p>
                            <p>&copy; ${new Date().getFullYear()} ${settings.siteName || 'TeachAide'}</p>
                            <p>A product of Cognovia Technologies Ltd · RC: 9394151</p>
                        </div>
                    </div>
                </body>
