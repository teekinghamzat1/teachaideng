                ...
                <>
                  <div className="flex items-center gap-4 border-l border-slate-200 pl-4 ml-2">
                    <span className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center">
                      {user.avatar ? (
                        <img src={user.avatar} alt={user.name} className="w-6 h-6 rounded-full mr-2 object-cover border border-slate-200 shadow-sm" />
                      ) : (
              ...
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                {user ? (
                  <>
                    ...
                    <div className="px-3 py-2 border-t border-slate-100 mt-2 flex items-center gap-3">
                      {user.avatar ? (
                    ...
                    <button
                      onClick={handleLogout}
                      className="flex items-center text-red-600 font-medium text-sm px-3 py-2"
                    >
